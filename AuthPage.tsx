...
import { Sprout, Mail, Lock, ArrowRight, UserPlus, LogIn, Ghost, CloudOff, AlertCircle } from 'lucide-react';
...
export const AuthPage: React.FC<Props> = ({ onLoginSuccess, onGuestAccess }) => {
    ...
    return (
        <div className="min-h-screen bg-soil-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
            {/* Background Image */}
            <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=2000')] bg-cover bg-center" />
