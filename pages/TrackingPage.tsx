    ...
    <div className="h-full flex flex-col bg-slate-50 relative">
      ...
      {isTracking && (
        <div className="h-full relative flex flex-col bg-slate-900">
            ...
            {/* BOTTOM CONTROLS AS OVERLAY (FIXED FOR FULLSCREEN) */}
            <div className="absolute bottom-0 left-0 right-0 z-[1001] pointer-events-auto bg-white/95 backdrop-blur-md p-4 rounded-t-3xl shadow-[0_-5px_20px_rgba(0,0,0,0.1)] border-t border-slate-200/50 pb-safe">
                ...
                <div className="flex space-x-3">
                    <button 
                        ...
                        className="bg-red-50 text-red-600 p-4 rounded-2xl font-bold shadow-sm hover:bg-red-100 transition-colors border border-red-100"
                        title="Abbrechen"
                    >
                        <Trash2 size={24} />
                    </button>
                    <button 
                        onClick={saveSession} 
                        className="flex-1 bg-slate-900 text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-slate-900/20 flex items-center justify-center hover:bg-black active:scale-[0.98] transition-all"
                    >
